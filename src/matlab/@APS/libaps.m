function [methodinfo,structs,enuminfo,ThunkLibName]=libaps
%LIBAPS Create structures to define interfaces found in 'libaps'.

%This function was generated by loadlibrary.m parser version 1.1.6.35 on Wed May  8 09:49:11 2013
%perl options:'libaps.i -outfile=libaps64.m -thunkfile=libaps64_thunk_pcwin64.c -header=libaps.h'
...
ThunkLibName=fullfile(MfilePath, APS.APS_ROOT, 'build/libaps_thunk_pcwin64');
%  int init (); 
...
fcns.thunkname{fcnNum}='int32int32int32int32voidPtrvoidPtrvoidPtrvoidPtrvoidPtrThunk';fcns.name{fcnNum}='set_LL_data_IQ'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int32', 'int32', 'int32', 'uint16Ptr', 'uint16Ptr', 'uint16Ptr', 'uint16Ptr', 'uint16Ptr'};fcnNum=fcnNum+1;
